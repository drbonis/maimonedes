"""Phase 1 page: latest compliance score per anchor.

Reads exclusively via helpers in `storage.dashboard_queries` so the
page itself stays a thin shim. Behaviour is unchanged from the
